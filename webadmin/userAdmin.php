                    ...
                    <?php 
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            <tr>
                                ...
                                <td><a href="userAdminEdit.php?id=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-success">
                                    <em class="fa fa-cogs"></em></a>
                                </td>
                                <td><a href="userAdminDel.php?id=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-danger">
    ...
    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="formInsert" class="modal fade">
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="userAdminInsertProses.php">
						...
						<div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                <input type="text" class="form-control" id="inputEmail4" placeholder="" name="nohp">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                              <input type="text" class="form-control" id="image" placeholder="" name="username">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail1" class="col-lg-2 control-label">Password</label>
                            <div class="col-lg-10">
                              <input type="password" class="form-control" id="inputEmail4" placeholder="" name="password">
                            </div>
                        </div>                                                    
                        <div class="form-group">
